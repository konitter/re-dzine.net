---
title: 「HTMLコーダー100の質問」に答えてみた
date: 2010-02-04 14:09:45
tags: article,
---
おもしろそうなのでやってみる。まぁ、純粋なコーダーではないですが。
...
<dl class="defineList">
  <dt><span class="number">1</span>年齢は？</dt>
  <dd>28歳</dd>
  <dt><span class="number">2</span>パソコン歴は？</dt>
  <dd>12年くらい？</dd>
  <dt><span class="number">3</span>コーダー歴はどれくらいですか？</dt>
  <dd>4年</dd>
  <dt><span class="number">4</span>初めてwebを作ったのはいつですか？</dt>
  <dd>大学生の時、授業で。ホームページビルダーで課題のサイト作りました。なんのサイトだったかは覚えていない・・・。</dd>
  <dt><span class="number">5</span>コーダーになろうと思ったきっかけは？</dt>
  <dd>コーダーを目指していたわけではないですが、上の大学の授業でCやら何やらのプログラムにつまらなさを感じていたぼくにとって衝撃的なセカイで、その魅力に完全にとりつかれてしまったのがきっかけ。</dd>
  <dt><span class="number">6</span>コーディングは誰に／どこで習いましたか？</dt>
  <dd>完全に独学です。</dd>
  <dt><span class="number">7</span>web業界以外の友達・家族とコーディングの話をしますか？</dt>
  <dd>しない。</dd>
  <dt><span class="number">8</span>ご両親はインターネットユーザーですか？</dt>
  <dd>一般的には結構なヘビーユーザだと思う。普通にネットショッピングやヤフオクやってる。</dd>
  <dt><span class="number">9</span>視力はいくつくらい？メガネ・コンタクトどちらですか？</dt>
  <dd>両方1.5。生涯裸眼。</dd>
  <dt><span class="number">10</span>本はAmazonで買いますか？</dt>
  <dd>ほぼ楽天です。</dd>
  <dt><span class="number">11</span>ネットショッピングをしますか？主に買うものは何ですか？</dt>
  <dd>よくします。楽天で本や洋服を買います。</dd>
  <dt><span class="number">12</span>携帯サイトで買い物をしたことがありますか？</dt>
  <dd>普段は利用しません。</dd>
  <dt><span class="number">13</span>お酒は強いですか？</dt>
  <dd>結構いける方だと思ってます。</dd>
  <dt><span class="number">14</span>休日の過ごし方を教えて下さい。</dt>
  <dd>子供と遊んだり。子供と遊んだり。</dd>
  <dt><span class="number">15</span>今、欲しいものは何ですか？</dt>
  <dd>MacBookPro。GR Digitalのテレコンレンズ。他多数。</dd>
  <dt><span class="number">16</span>平均睡眠時間を教えて下さい。</dt>
  <dd>8時間</dd>
  <dt><span class="number">17</span>平日の起床時間は何時ですか？</dt>
  <dd>7時30分</dd>
  <dt><span class="number">18</span>なにかスポーツをしていますか？</dt>
  <dd>草サッカーのチームに入ってます。未経験なのでへたっぴです。週末にはたまにランニングします。</dd>
  <dt><span class="number">19</span>パソコンと関係ない趣味がありますか？</dt>
  <dd>Perfumeに激はまり中。</dd>
